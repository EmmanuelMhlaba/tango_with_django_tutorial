...
def populate():
    python_pages = [
        ...
        {"title": "Learn Python in10 Minutes", "url": "http://www.korokithakis.net/tutorials/python/", "views": 1},
    ]

    django_pages = [
        {"title": "Official Django Tutorial", "url": "https://docs.djangoproject.com/en/1.9/intro/tutorial01/", "views": 18},
    ...
    other_pages = [
        ...
        {"title": "Flask", "url": "http://flask.pocoo.org", "views": 2}
    ]
